...
jQuery(function (e) {
    ...
    var t = {
        ...
        get_payment_method: function () {
            console.log(t.$checkout_form.find('input[name="payment_method"]:checked').val());
        ...
        validate_field: function (t) {
            var o = e(this), c = o.closest(".form-row"), i = !0, r = c.is(".validate-required"),
                n = c.is(".validate-email"), a = t.type;
        ...
        update_checkout_action: function (o) {
            if (t.xhr && t.xhr.abort(), 0 !== e("form.checkout").length) {
                ...
                var c = e("#billing_country").val(), i = e("#billing_state").val(),
                    r = e("input#billing_postcode").val(), n = e("#billing_city").val(),
                    a = e("input#billing_address_1").val(), u = e("input#billing_address_2").val(), d = c, s = i, m = r,
                    p = n, h = a, _ = u, l = e(t.$checkout_form).find(".address-field.validate-required:visible"),
                    f = !0;
                    ...
                    success: function (o) {
                        ...
                        if (!0 !== o.reload) {
                            ...
                            if (e(".payment_box input").each(function () {
                                ...
                                e(".woocommerce-error, .woocommerce-message").remove(), o.messages ? n.prepend('<div class="woocommerce-NoticeGroup woocommerce-NoticeGroup-updateOrderReview">' + o.messages + "</div>") : n.prepend(o), n.find(".input-text, select, input:checkbox").trigger("validate").blur(), e("html, body").animate({scrollTop: e("form.checkout").offset().top - 100}, 1e3)
                            }
                             e(document.body).trigger("updated_checkout", [o])
        ...
        submit: function () {
            ...
            return !o.is(".processing") && (!1 !== o.triggerHandler("checkout_place_order") && !1 !== o.triggerHandler("checkout_place_order_" + t.get_payment_method()) && (o.addClass("processing"), 1 !== o.data()["blockUI.isBlocked"] && o.block({
                    ...
                    success: function (o) {
                        ...
                        try {
                            if ("success" !== o.result)throw"failure" === o.result ? "Result failure" : "Invalid response";
                            -1 === o.redirect.indexOf("https://") || -1 === o.redirect.indexOf("http://") ? window.location = o.redirect : window.location = decodeURI(o.redirect)
                        } catch (c) {
        ...
        init: function () {
            ...
            return e.ajax({
                ...
                data: o,
                success: function (o) {
                    e(".woocommerce-error, .woocommerce-message").remove(), t.removeClass("processing").unblock(), o && (t.before(o), t.slideUp(), e(document.body).trigger("update_checkout", {update_shipping_method: !1}))
                },
                dataType: "html"
            }), !1
        }, remove_coupon: function (t) {
            t.preventDefault();
            var o = e(this).parents(".woocommerce-checkout-review-order"), c = e(this).data("coupon");
            o.addClass("processing").block({message: null, overlayCSS: {background: "#fff", opacity: .6}});
            var i = {security: wc_checkout_params.remove_coupon_nonce, coupon: c};
            e.ajax({
                type: "POST",
                url: wc_checkout_params.wc_ajax_url.toString().replace("%%endpoint%%", "remove_coupon"),
                data: i,
                success: function (t) {
                    e(".woocommerce-error, .woocommerce-message").remove(), o.removeClass("processing").unblock(), t && (e("form.woocommerce-checkout").before(t), e(document.body).trigger("update_checkout", {update_shipping_method: !1}), e("form.checkout_coupon").find('input[name="coupon_code"]').val(""))
                },
                error: function (e) {
